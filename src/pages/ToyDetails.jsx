        ...
        <div>
            ...
            <main>
                <div className='max-w-[1200px] mx-auto px-5 w-full toy-details'>
                    <div className="bg-base-100 mt-5 my-12 md:my-20 flex gap-10">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <h2 className="card-title text-[42px] font-black mt-4">{toyName}</h2>
                            <p className='text-[32px] font-bold mt-4'>${price}</p>
