...
const Reviews = () => {
    return (
        <div className='max-w-[100%] mx-auto px-5 w-full'>
            <div className='mt-12 md:mt-20 mb-15 md:mb-25'>
                <h2 className='text-[28px] md:text-[36px] uppercase text-center text-secondary mb-12 font-black'>Reviews From Our Customers</h2>
                <>
                    <Swiper
                        slidesPerView={2}
                        spaceBetween={30}
                    ...
                    >
                        <SwiperSlide className='pl-10 pr-10'>
