    ...
    return (
       <div className='bg-[linear-gradient(78deg,#ffcf78_5%,#ffcf78_97%)]'>
            <div className='max-w-[1200px] mx-auto px-5'>
                <div className='flex-col lg:flex-row flex align-middle items-center gap-10 w-full pt-20 pb-20 lg:pb-10 lg:pt-10'>
                    <div className='banner_right flex-1'>
                        <img className='max-w-[556px] w-full' src={banner_img} alt="Banner" />
                    </div>
                    <div className='banner_left flex-1 flex flex-col items-center lg:items-start'>
                        <h2 className='text-[45px] lg:text-[55px] font-extrabold mb-4 text-center lg:text-left'>The Best Kids Toy Store in the City</h2>
